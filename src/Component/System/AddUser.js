    ...
    <div className="col-5 py-2 px-5 offset-3 shadow">
      ...
      <form onSubmit={(e) => saveuser(e)}>
        ...
        <div className="input-group mb-5">
            <label
            className="input-group-text" htmlFor="name" role='usrname'>Name:</label>
            <input
        ...
        <div className="input-group mb-5">
            <label
            className="input-group-text" htmlFor="description" role='cityname'>city:</label>
            <input
            className="form-control col-sm-6"
             type="text" 
             name="city"
        ...
        <div className="input-group mb-5">
            <label
            className="input-group-text" htmlFor="description" role='emailname'>email:</label>
            <input
            className="form-control col-sm-6"
             type="text" 
             name="email"
        ...
        <div className="input-group mb-5">
            <label
            className="input-group-text" htmlFor="description" role='phonename'>Phone number:</label>
            <input
            className="form-control col-sm-6"
             type="text" 
             name="phoneno"
