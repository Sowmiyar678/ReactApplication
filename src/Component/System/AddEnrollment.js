    ...
    <div className="col-5 py-2 px-5 offset-3 shadow">
      ...
      <form onSubmit={(e) => saveStudent(e.Enrollment)}>
        <div className="input-group mb-5">
          <label className="input-group-text" htmlFor="date" role="date">
            Date:
          </label>
          <input
        ...
        <div className="input-group mb-5">
          <label className="input-group-text" htmlFor="userid" role="userid">
            User ID:
          </label>
          <select
            className="form-control col-sm-6"
        ...
        <div className="input-group mb-5">
          <label className="input-group-text" htmlFor="courseId" role="courseid">
            Course ID:
          </label>
          <select
            className="form-control col-sm-6"
